...
- 🎯 Entry points to execute your program using `python -m <flask_backend>` or `$ flask_backend` with basic CLI argument parsing.
...
---
# flask_backend Flask Application

Awesome flask_backend created by 2021UESTCDbExperimentGroup18
...
```bash
flask_backend create-db   # run once
flask_backend populate-db  # run once (optional)
flask_backend add-user -u admin -p 1234  # ads a user
flask_backend run
```
